    ...
    <div>
      ...
      <Row className="mb-3">
        <Col md={12}>
          ...
          <Form.Check inline type="checkbox" label="USA" id="usa" />
          <Form.Check inline type="checkbox" label="Azerbaijan" id="azerbaijan" />
          <Form.Check inline type="checkbox" label="Lithuania" id="lithuania" />
          <Form.Check inline type="checkbox" label="Ethiopia" id="ethiopia" />
          <Form.Check inline type="checkbox" label="Ireland" id="ireland" />
        </Col>
      </Row>
